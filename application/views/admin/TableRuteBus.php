            ...
            <div class="content">
                <div class="main">
                    <div class="page-header">
                        <h4 class="page-title">Data Bus</h4>
                    </div>
                    <div>
                        <a href="<?= base_url('tiket/tambahRute') ?>">
                            <button class="btn btn-primary">Tambah Data Bus</button>
                        </a>
                    </div>
                    <br>
                    <div class="card">
                                ...
                                <table id="data-table" class="table data-table">
                                    <thead>
                                        <tr class="main-title">
                                            ...
                                            <td class="text-center" scope="col">KELAS</td>
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td class="text-center">
                                                    <a href="#" class="btn btn-danger"
                                                        onclick="confirmDelete(event, <?= $rt->id ?>)">
                                                        <i class="fa-regular fa-trash"></i>
                                                    </a>
                                                    <a href="#" class="btn btn-primary"
                                                        onclick="confirmEdit(event, <?= $rt->id ?>)">
                    ...
                    function confirmEdit(event, id) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                window.location.href = "<?= base_url('tiket/editBus/') ?>" + id;
                            }
                        });
                    }
                    ...
                    function confirmDelete(event, id) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                window.location.href = "<?= base_url('tiket/hapus_rute/') ?>" + id;
                            }
                        });
                    }
                </script>

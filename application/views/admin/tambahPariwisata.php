        ...
        <div class="vertical-layout">
            ...
            <div class="content">
                <div class="main">
                    ...
                    <br>
                    <form action="<?= base_url('tiket/simpanPariwisata') ?> " method="POST">
                        <!-- Form di sebelah kiri -->
                        <div class="card">
                            <div class="card-body">
                                <h5>Tambahkan Tempat Wisata</h5>
                                <div id="formWisata">
    ...
    <!-- <script>
        ...
        function updateCities() {
            ...
            if (selectedProvince === "Jawa Barat") {
                var cities = ["Bandung", "Tasikmalaya", "Pangandaran"]; 
            ...
            if (selectedProvince === "Jawa Tengah") {
                var cities = ["Semarang", "Solo", "Magelang"]; 
                cities.forEach(function (city) {
                    var option = document.createElement("option");
                    option.value = city;
                    option.text = city;
            ...
            if (selectedProvince === "DKI Jakarta") {
                var cities = ["Jakarta Pusat", "Jakarta Barat", "Jakarta Selatan"]; 
                cities.forEach(function (city) {
                    var option = document.createElement("option");
                    option.value = city;
                    option.text = city;

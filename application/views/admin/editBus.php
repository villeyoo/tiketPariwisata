                ...
                <ul class="nav-menu">
                    ...
                    <li class="nav-menu-item router-link-active">
                        <a href="#">
                            ...
                            <span class="nav-menu-item-title">Edit Data Bus</span>
                        </a>
                    </li>
                    <!-- <li class="nav-menu-item">
            ...
            <div class="content">
                <div class="main">
                    <div class="page-header">
                        <h4 class="page-title">Edit Rute Bus</h4>
                    </div>

                    <br>
                    <form action="<?= base_url('tiket/updateBus') ?> " method="POST">
                        <!-- Form di sebelah kiri -->
                        <div class="card">
                            <div class="card-body">
                                <h5>ID BUS</h5>
                                <p style="color:red;">ID TIDAK BISA DI RUBAH</p>
                                <!-- Pengguna dapat menambahkan lebih dari satu tempat wisata dengan menekan tombol "Tambah Tempat Wisata" -->
                                <div>
                                    <input type="text" name="id" name="id" style="width:100%;" class="input-text"
                                        value="<?= $rute['id'] ?>" readonly>
                                    <!-- Pengguna dapat menambahkan lebih banyak input sesuai kebutuhan -->
                                </div>
                                <h5>Pilih Kelas Bus</h5><i>yang di pilih sebelumnya</i>
                                <select id="Kelas" name="Kelas" class="select-box" required>

                                    <option value="" disabled selected>Pilih Kelas Bus</option>
                                    <option value="Non Ac" <?= ($rute['Kelas'] == 'Non Ac') ? 'selected' : '' ?>>Non AC
                                    </option>
                                    <option value="Ekonomi AC" <?= ($rute['Kelas'] == 'Ekonomi AC') ? 'selected' : '' ?>>
                                        Ekonomi Ac
                                    </option>
                                    <option value="Ekonomi Non AC" <?= ($rute['Kelas'] == 'Ekonomi Non AC') ? 'selected' : '' ?>>
                                        Ekonomi Non AC
                                    </option>
                                    <option value="Eksekutif" <?= ($rute['Kelas'] == 'Eksekutif') ? 'selected' : '' ?>>
                                        Eksekutif
                                    </option>
                                    <option value="Bisnis" <?= ($rute['Kelas'] == 'Bisnis') ? 'selected' : '' ?>>
                                        Bisnis
                                    </option>
                                </select>
                                <h5>Harga</h5>

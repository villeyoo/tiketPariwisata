            ...
            <div class="content">
                <div class="main">
                    <div class="page-header">
                        <h4 class="page-title">Edit Kelas Bus</h4>
                    </div>

                    <br>
                    <form action="<?= base_url('tiket/updateKelasBus') ?> " method="POST">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5>Masukan Kelas Bus</h5>
                                <p>Kelas Bus sebelumnya
                                    <?= $kelas['Kelas'] ?>
                                </p>
                                <div>
                                    <input type="text" name="kelas" id="kelas" style="width:100%;" class="input-text"
                                        placeholder="Masukkan Kelas Bus"
                                        oninput="this.value = this.value.replace(/\b\w/g, l => l.toUpperCase());"
                                        required>
                                    <!-- Pengguna dapat menambahkan lebih banyak input sesuai kebutuhan -->
                                </div>
                                <br>

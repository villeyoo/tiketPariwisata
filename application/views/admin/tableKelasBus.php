            ...
            <div class="content">
                <div class="main">
                    <div class="page-header">
                        <h4 class="page-title">Data Kelas Bus</h4>
                    </div>
                    <div>
                        <a href="<?= base_url('tiket/tambahKelas') ?>">
                            <button class="btn btn-primary">Tambah Kelas Bus</button>
                        </a>
                    </div>
                    <br>
                    <div class="card">
                                ...
                                <table id="data-table" class="table data-table">
                                    <thead>
                                        <tr class="main-title">
                                            ...
                                            <td class="text-center" style="width: 30%" scope="col">Kelas Bus
                                            </td>
                                            ...
                                            <tr class="text-center" style="font-weight:500;">
                                                ...
                                                <td class="text-center">
                                                    <a href="#" class="btn btn-danger"
                                                        onclick="confirmDelete(event, <?= $bs->id ?>)">
                                                        <i class="fa-regular fa-trash"></i>
                                                    </a>
                                                    <a href="#" class="btn btn-primary"
                                                        onclick="confirmEdit(event, <?= $bs->id ?>)">
                    ...
                    function confirmEdit(event, id) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                window.location.href = "<?= base_url('tiket/editKelasBus/') ?>" + id;
                            }
                        });
                    }
                    ...
                    function confirmDelete(event, id) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                window.location.href = "<?= base_url('tiket/hapus_kelasBus/') ?>" + id;
                            }
                        });
                    }
                </script>

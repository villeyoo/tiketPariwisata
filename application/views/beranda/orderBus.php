        ...
        <section class="booking-section">
            ...
            <div class="auto-container">
                <div class="title-box centered">
                    <h2><span>Pesan Tiket Bus</span></h2>
                        ...
                        <form method="post" action="contact.html">
                            <div class="row clearfix">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <div class="field-inner">
                                        <input type="text" name="NIK" id="NIK" value="" placeholder="" required>
                                    </div>
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12">
                                ...
                                <!-- Bagian View (HTML) -->
                                <div class="form-group col-lg-6 col-md-6 col-sm-12">
                                    <div class="f-label">Pilih Kelas Bus? <i>*</i></div>
                                    <div class="field-inner">
                                        <select name="Kota" id="Kota">
                                            <option value="" disabled selected>Pilih Kelas Bus</option>
                                            <?php foreach ($kelas_list as $bus): ?>
                                                <option value="<?php echo $bus['Kelas']; ?>">
                                                    <?php echo $bus['Kelas']; ?>
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <div class="field-inner">
                                        <input type="text" class="datepicker" name="tgl_berangkat" id="tgl_berangkat"
                                            value="" placeholder="" required>
                                        <span class="alt-icon fal fa-calendar fa-fw"></span>
                                    </div>
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12">
                                    <div class="f-label">Jumlah Penumpang <i>*/</i><i>bukan lansia jika kurang dari 60
                                            tahun</i></div>
                                    <div class="field-inner">
                                        <input type="text" name="penumpang" id="penumpang" value="" placeholder=""
                                            required>
                                    </div>
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12">
                                    <div class="f-label">Jumlah Penumpang lansia <i>*/usia di atas 60 tahun</i></div>
                                    <div class="field-inner">
                                        <input type="text" name="Anak-anak" id="Anak-anak" value="" placeholder=""
                                            required>
                                    </div>
                                </div>
